...
export class Backend implements backendInterface {
    ...
    async _initializeAccessControlWithSecret(_secret: string): Promise<void> {
        // no-op: authorization bootstrap not applicable for this backend
    }
    ...
    async getCustomRequests(): Promise<Array<CustomRequest>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCustomRequests();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getOrdersByWhatsapp(arg0: string): Promise<Array<Order>> {
        if (this.processError) {
            try {
                const result = await this.actor.getOrdersByWhatsapp(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async placeOrder(arg0: string, arg1: Order): Promise<void> {
        if (this.processError) {
            try {
    ...
    async submitCustomRequest(arg0: string, arg1: CustomRequest): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitCustomRequest(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
