import { r as reactExports, m as useCart, o as useRouter, f as useActor, i as useQuery, j as jsxRuntimeExports, p as motion, w as Search, I as Input, x as ShoppingCart, l as ue } from "./index-DK08b9MR.js";
              ...
              TiltCard,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden aspect-square", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-[oklch(0.08_0_0/0.6)] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-400" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-cinzel text-sm font-semibold tracking-wide text-foreground mb-2", children: product.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[oklch(var(--text-muted))] text-xs mb-3 line-clamp-2", children: product.formats }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-cinzel text-lg font-bold text-gold", children: product.priceUsd }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        motion.button,
                        {
                          type: "button",
